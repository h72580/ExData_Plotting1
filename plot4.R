...
# setup the plots
# first we setup the multiple frame:
par(mfrow=c(2,2))
# then we add the plots:

# * plot n. 1 BEGIN
# setup the plot
with(dataset, plot(datetime, Global_active_power, type="n", ylab = "Global Active Power", xlab = ""))
# plot the graphic
...
# column three times
with(dataset, plot(rep.int(datetime, 3) , submeterings, type="n", 
